...
gaze_origin_y = None
scroll_job = None
scroll_speed_dynamic = 0.5
scroll_dir = 1
scroll_ts = None

global_last_mouse_pos = 0
...
class Actions:
    ...
    def mouse_scrolling(direction: str):
        ...
        global scroll_job, scroll_dir, scroll_ts, global_last_mouse_pos
        ...
        if scroll_job is None:
            ...
            scroll_job = cron.interval("100ms", scroll_continuous_helper)
